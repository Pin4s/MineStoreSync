  ...
  return (
    ...
    >
      <div className="space-y-3">
        <p className="text-[11px] uppercase tracking-[0.34em] text-[#86efac]">main.dashboard</p>
        <div className="space-y-2">
          ...
          <p className="max-w-2xl text-sm leading-6 text-[#6b7280]">
            Visão geral da integração CentralCart e automações ativas.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <Button
          ...
          className="relative h-11 overflow-hidden rounded-none border border-[#22c55e] bg-[#22c55e] px-5 font-[family:var(--font-jetbrains-mono)] text-xs font-bold uppercase tracking-[0.28em] text-[#031404] transition-colors duration-150 hover:bg-[#16a34a]"
        >
          + Nova automação
        </Button>
      </div>
