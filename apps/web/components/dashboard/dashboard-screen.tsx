...
const sidebarItems = [
  ...
  { id: "automations", label: "Automações", href: "#automations" },
  { id: "integration", label: "Integração", href: "#integration" },
...
export function DashboardScreen() {
  ...
  const loadIntegration = async () => {
    ...
    try {
      ...
      const message =
        error instanceof Error ? error.message : "Falha ao carregar o status da integração.";
  ...
  const loadAutomations = async () => {
    ...
    try {
      ...
      const message =
        error instanceof Error ? error.message : "Falha ao carregar as automações.";
      ...
      <div className="relative z-10 lg:pl-[272px]">
        <div className="mx-auto max-w-[1600px] px-4 pb-10 pt-20 sm:px-6 lg:px-8 lg:pt-8">
          <div className="space-y-6">
            ...
            <MetricsGrid items={[...metrics]} loading={automationsLoading && automations.length === 0} />
            ...
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1.7fr)_320px]">
              ...
              <aside id="settings" className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid gap-3 text-sm text-[#6b7280]">
                      <div className="panel-surface-soft p-3">
                        ...
                        <p className="mt-2 text-[#f0f0f0]">{integration?.storeName ?? "CentralCart"}</p>
                      </div>
                      <div className="panel-surface-soft p-3">
                        <p className="text-[10px] uppercase tracking-[0.24em] text-[#6b7280]">
                          RCON
